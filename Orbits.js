 ...
 * @returns 
 */
Orbits.computeNaturalAnomaly = function(ecc_norm, E)
{
 ...
 * @returns The period.
 */
Orbits.computePeriod = function(a, mu)
{
 ...
 */
Orbits.solveEccentricAnomaly = function(M, e, tolerance, maxIterations)
{
 ...
 */
Orbits.osvToKepler = function(r, v, ts)
{
    let kepler = {};
 ...
 * @returns OSV
 */
Orbits.propagate = function(kepler, dateIn)
{
    if (kepler.a == 0)
    {
        return;
    ...
    let Mext = kepler.M + 360.0 * diff / (Orbits.computePeriod(kepler.a, kepler.mu) * 1000.0);
